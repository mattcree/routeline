...
public class RoutefinderTest {
    ...
    @Test
    public void generateDistancesFromShouldPopulateStops() {
        Network network = createNetwork();
        Routefinder rf = new Routefinder(network);
        rf.generateDistancesFrom(network.getStop("York", "A"));
        Assert.assertTrue(!rf.getCalculatedStops().isEmpty());
    }

    @Test
    public void getShortestRouteGeneratesRoute() {
        Network network = createNetwork();
        Routefinder rf = new Routefinder(network);
        rf.generateDistancesFrom(network.getStop("Northallerton", "B"));
        System.out.println(rf.timeForRoute(network.getStop("Berwick-upon-Tweed", "A")));
    }
